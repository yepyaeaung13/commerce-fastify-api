...
async function getProductById(request, reply) {
    try {
        ...
        if (!product) {
            return reply.status(404).send((0, helpers_1.errorResponse)('Product not found'));
        }
        return reply.send((0, helpers_1.successResponse)(product, 'Product retrieved successfully'));
    }
    catch (error) {
        return reply.status(500).send((0, helpers_1.errorResponse)(error?.message || 'Internal server error'));
    }
...
async function createProduct(request, reply) {
    try {
        ...
        return reply.status(201).send((0, helpers_1.successResponse)(product, 'Product created successfully'));
    }
    catch (error) {
        return reply.status(500).send((0, helpers_1.errorResponse)(error?.message || 'Internal server error'));
    }
...
async function updateProduct(request, reply) {
    try {
        ...
        return reply.send((0, helpers_1.successResponse)(product, 'Product updated successfully'));
    }
    catch (error) {
        return reply.status(500).send((0, helpers_1.errorResponse)(error?.message || 'Internal server error'));
    }
...
async function deleteProduct(request, reply) {
    try {
        ...
        return reply.send((0, helpers_1.successResponse)({}, 'Product deleted successfully'));
    }
    catch (error) {
        return reply.status(500).send((0, helpers_1.errorResponse)(error?.message || 'Internal server error'));
    }
...
async function updateProductStock(request, reply) {
    try {
        ...
        return reply.send((0, helpers_1.successResponse)(product, 'Product stock updated successfully'));
    }
    catch (error) {
        return reply.status(500).send((0, helpers_1.errorResponse)(error?.message || 'Internal server error'));
    }
